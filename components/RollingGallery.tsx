...
const RollingGallery: React.FC<RollingGalleryProps> = ({ autoplay = false, pauseOnHover = false, images }) => {
  if (!images || images.length === 0) images = IMGS;
  // hydration-safe screen size detection
  ...
  // تم حذف الأسهم نهائياً بناءً على طلب المستخدم

  return (
    <div className="gallery-container relative select-none">
      <div className="gallery-gradient gallery-gradient-left"></div>
      <div className="gallery-gradient gallery-gradient-right"></div>
      {/* أسهم جديدة ثابتة وسليمة */}
